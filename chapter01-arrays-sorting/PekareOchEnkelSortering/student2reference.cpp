...
void experimentMedParameteroverforing(){
    ...
    /* TODO!!
       ...
       (förklara allt som efterfrågas i kompendiet!)
        ...
        Eftersom adress2 skriver en ny const med nya värden och adress3 pekar på andress2

        2. Varför är de adresser som skrivAdresser1 skriver ut mindre än de som
        skrivAdresser2 skriver ut?

        För att adress1 kallas först och adress2 kallas efter vilket leder till att adress2 stackar över adress1.

        3. Kan man i utskrifterna se hur lång (antal byte) en int respektive
        float är?

        Man kan se igenom att se hur många siffror de är imellan intval1 och intval2 vilket är 4 byte, sen kan man också se att på
        m_intValue3 att värden ändras 0x9dde68 till 0x9dee08. Så värden va först 0x9dde68 och sen i intval3 blir den 0x9dee08 och då ser vi
        att d värdet som är 13 ändras till e värde vilket är 14.
     */
}
